...
namespace AWK.Data
{
    ...
    public partial class AwkEntities : DbContext
    {
        public AwkEntities()
            : base("name=AwkEntities")
        {
        }
        ...
        [DbFunction("AwkEntities", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[AwkEntities].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
